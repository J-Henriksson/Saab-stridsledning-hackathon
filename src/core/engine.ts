...
import { createAircraftUnit, createAirDefenseUnit, createDroneUnit, createRadarUnit, normalizeActiveDeployedDroneUnit } from "@/core/units/factory";
...
function migrateFriendlyEntityToUnit(entity: FriendlyEntity): Unit {
  ...
  switch (entity.category) {
    ...
    case "radar":
      return createRadarUnit({ ...common, type: "SEARCH_RADAR" });
    case "drone":
      return createDroneUnit({ ...common, type: "ISR_DRONE" });
  }
}
